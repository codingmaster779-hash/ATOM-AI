      ...
      return (
        <div className="h-screen bg-black flex items-center justify-center text-white p-4">
          <div className="bg-gray-900 p-6 rounded-xl border border-red-500/50 max-w-md w-full text-center">
            ...
            <p className="text-xs text-gray-400 font-mono mb-4 bg-black p-2 rounded">
              {this.state.error?.message || "Unknown error"}
            </p>
            <button onClick={() => window.location.reload()} className="bg-blue-600 px-4 py-2 rounded-lg flex items-center gap-2 mx-auto">
